        ...
        <div className="lg:flex">
            ...
            <NavbarWeb />
                ...
                <div className="mb-8 mt-4">
                    ...
                    <img src={actionData?.image} alt={actionData?.alt} className="max-h-72 rounded-lg" />    
                    <div className="mt-2 p-2">
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        <>
                          ...
                          >
                          <HeartIcon
                            className={favoritesData?.favorites.find((s) => s.actionId === actionId) ? "[&>path]:stroke-transparent" : "animate__bounceIn  animate__delay-2s"}
